...
How to Run
Open the project in any Java runner Run the Main.java file. Enter the required details when prompted (doctor, patient, nurse, and surgery). The system will display the information and show the total bill.
